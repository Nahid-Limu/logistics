            ...
            <div class="panel-heading">
                <div class="row">
                        <div class="panel-heading clearfix">
                                <h4 class="panel-title pull-left" style="padding-top: 7.5px;">Vendor Wise Order History (Vendor Name: <b>{{$vendor_details->name}}</b>, Report From: <b>{{date('d-m-Y', strtotime($request->start_date))}} to {{date('d-m-Y', strtotime($request->end_date))}}</b>)</h4>
