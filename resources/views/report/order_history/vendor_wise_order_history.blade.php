...
@section('content')
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title"><b>Vendor Wise Order History</b></div>
        </div>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-blue">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method'=>'POST','route'=>'report.vendors_wise_order_history_data']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <select name="orderStatus" required="" class="form-control" id="orderStatus" >
                                        <option value="all">All</option>
                                        <option value="0">Pending</option>
                                        <option style="color:blue" value="1">Approved(Waiting for Delivery)</option>
                                        <option style="color:red" value="2">Rejected</option>
                                        <option  style="color:green"  value="3">Delivered</option>
                                </select>
                            </div>
                            <br/>
                            <div class="form-group">
