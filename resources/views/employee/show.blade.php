                ...
                <div class="panel">
                    <div class="panel-body profile-panel-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab-education" data-toggle="tab" aria-expanded="false">Educational Info</a></li>
                            <li><a href="#tab-nominee" data-toggle="tab" aria-expanded="false">Nominee</a></li>
                                ...
                                {{--<div class="row pb-r">--}}
                                    @foreach($emp_edu as $e)
                                        <div>
                                            ...
                                            <div class="col-md-4">
                                                <a href="{{route('employee_education.edit',$e->id)}}" class="btn btn-xs edit_btn edit_education_btn" title="Edit" style="float: left"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('employee_education.destroy',base64_encode($e->id))}}" onclick="return confirm('Are you sure you want to delete?');" title="Delete" style="padding-left: 10px; margin-left: 10px" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
