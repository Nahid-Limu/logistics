            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-6" style="text-align: right;">
                        <a href="{{route('area.create')}}" class="add-new-modal btn btn-success btn-square btn-sm"> <i class="fa fa-plus"></i> Add New</a>
                    </div>
                </div>
            </div>
                ...
                <table id="example" class="table table-hover table-bordered">
                    ...
                    @foreach($area as $key=>$areas)
                        <tr>
                            ...
                            <td>
                                <a class="view-modal-btn" href="{{route('area.show',$areas->id)}}"><button type="button" class="btn btn-blue btn-xs"><i class="fa fa-eye"></i>&nbsp;View</button></a>&nbsp;&nbsp;&nbsp;
                                <a class="edit-modal-btn" href="{{route('area.edit',$areas->id)}}"> <button type="button" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i>&nbsp;&nbsp;Edit</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
