...
@section('title', 'Receive Payment from Vendor')
@section('extra_css')
...
@section('content')
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title"><b>Receive Payment from Vendor</b></div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{URL('/')}}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><a href="#">Receive Payment from Vendor</a>&nbsp;&nbsp;
        </ol>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-blue">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method'=>'POST','route'=>'payment.receive_payment_store']) !!}
                            ...
                            <br/>
                            <div class="form-group">
                                <label for="paymentAmount">Received Amount</label>
